...
export default function Hero() {
  return (
    <section
      className="relative text-center py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6"
      style={{
        background:
    ...
    >
      ...
      <p className="lead text-sm sm:text-base md:text-lg px-4">
      ...
      {/* Floating Cards */}
      <div className="mt-8 sm:mt-12 md:mt-16 flex justify-center gap-3 sm:gap-4 md:gap-6 flex-wrap">
        <div
          role="img"
          aria-label="Hero Card 1"
          className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-lg rotate-[-6deg] overflow-hidden bg-cover bg-center bg-no-repeat bg-[url('/assets/images/image.png')]"
        />

        <div
          role="img"
          aria-label="Hero Card 2"
          className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-lg rotate-[3deg] overflow-hidden bg-cover bg-center bg-no-repeat bg-[url('/assets/images/image-2.png')]"
        />

        <div
          role="img"
          aria-label="Hero Card 3"
          className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-lg rotate-[6deg] overflow-hidden bg-cover bg-center bg-no-repeat bg-[url('/assets/images/image-3.png')]"
        />
      </div>
    </section>
  );
