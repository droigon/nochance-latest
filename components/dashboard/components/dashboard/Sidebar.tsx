...
export default function Sidebar() {
  ...
  const links = [
    { name: "Dashboard", href: "/verifications/personal", icon: ShieldCheck },
    { name: "Manage Reviews", href: "/verifications/personal", icon: FileText },
    { name: "Get Reviews", href: "/verifications/personal", icon: User },
    { name: "Analytics", href: "/verifications/personal", icon: Building2 },
    { name: "Settings", href: "/verifications/personal", icon: Settings },
  ];
